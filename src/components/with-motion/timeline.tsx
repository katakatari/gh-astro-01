...
export const Timeline = (
  { data, className }: { data: TimelineEntry[]; className?: string },
) => {
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-sm md:text-base max-w-sm">
          ...
          iure non dolores consectetur ea, dolorum ipsum nihil maxime cupiditate
          officiis vitae rem, aliquam aperiam natus quas suscipit! Nemo,
          veritatis!
        </p>
      </div>
